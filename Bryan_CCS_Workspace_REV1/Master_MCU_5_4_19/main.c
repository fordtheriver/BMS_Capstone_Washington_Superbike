...
SystemState SleepHandler(void);
SystemState CheckCellsHandler(void);
SystemState BalanceCellsHandler(void);

SystemState NextState = SleepState;
...
SystemState CheckCellHandler(void)
{
